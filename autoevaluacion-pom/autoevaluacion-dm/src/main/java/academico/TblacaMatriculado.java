...
public class TblacaMatriculado implements Serializable {
	...
	public void setTblestEstudiantePrograma(
			TblestEstudiantePrograma tblestEstudiantePrograma) {
